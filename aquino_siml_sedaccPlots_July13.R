...
const_supp_siml_gam_1_initJuly13_accurate <- 1/const_supp_siml_gam_1_initJuly13_accurate[,2:ncol(const_supp_siml_gam_1_initJuly13_accurate)]
const_supp_siml_tdistr_gam_1_initJuly13_accurate <- 1/const_supp_siml_tdistr_gam_1_initJuly13_accurate[,2:ncol(const_supp_siml_tdistr_gam_1_initJuly13_accurate)]
...
p3 <- siml_aquino_gam_plot_df %>%
  ...
  scale_y_continuous(name= bquote("Median MAR " (~cm~yr^-1)), breaks = seq(0, 25, 1.5))+
  theme_bw()+
