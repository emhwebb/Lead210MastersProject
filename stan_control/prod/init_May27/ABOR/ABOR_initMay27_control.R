...
#ABOR1309_01PU
ABOR1309_01_initMay3_ages_summ <- t(apply(X = ABOR1309_01_initMay3_ages[,1:ncol(ABOR1309_01_initMay3_ages)], 
                                          MARGIN = 2, 
                                          FUN = function(a) c(mean(a), sd(a), quantile(a, c(0.025, 0.25, 0.5, 0.75, 0.975)))))
colnames(ABOR1309_01_initMay3_ages_summ)[1:2] <- c("mean", "sd")

ABOR1309_01_initMay3_accurate_summ <- t(apply(X = ABOR1309_01_initMay3_accurate[,1:ncol(ABOR1309_01_initMay3_accurate)], 
                                              MARGIN = 2, 
                                              FUN = function(a) c(mean(a), sd(a), quantile(a, c(0.025, 0.25, 0.5, 0.75, 0.975)))))
...
#ABOR1309_03PU
ABOR1309_03_initMay3_ages_summ <- t(apply(X = ABOR1309_03_initMay3_ages[,1:ncol(ABOR1309_03_initMay3_ages)], 
                                          MARGIN = 2, 
                                          FUN = function(a) c(mean(a), sd(a), quantile(a, c(0.025, 0.25, 0.5, 0.75, 0.975)))))
colnames(ABOR1309_03_initMay3_ages_summ)[1:2] <- c("mean", "sd")

ABOR1309_03_initMay3_accurate_summ <- t(apply(X = ABOR1309_03_initMay3_accurate[,1:ncol(ABOR1309_03_initMay3_accurate)], 
                                              MARGIN = 2, 
                                              FUN = function(a) c(mean(a), sd(a), quantile(a, c(0.025, 0.25, 0.5, 0.75, 0.975)))))
...
#ABOR1309_04PU
ABOR1309_04_initMay3_ages_summ <- t(apply(X = ABOR1309_04_initMay3_ages[,1:ncol(ABOR1309_04_initMay3_ages)], 
                                          MARGIN = 2, 
                                          FUN = function(a) c(mean(a), sd(a), quantile(a, c(0.025, 0.25, 0.5, 0.75, 0.975)))))
colnames(ABOR1309_04_initMay3_ages_summ)[1:2] <- c("mean", "sd")

ABOR1309_04_initMay3_accurate_summ <- t(apply(X = ABOR1309_04_initMay3_accurate[,1:ncol(ABOR1309_04_initMay3_accurate)], 
                                              MARGIN = 2, 
                                              FUN = function(a) c(mean(a), sd(a), quantile(a, c(0.025, 0.25, 0.5, 0.75, 0.975)))))
...
#ABOR1702_01PU
ABOR1702_01_initMay3_ages_summ <- t(apply(X = ABOR1702_01_initMay3_ages[,1:ncol(ABOR1702_01_initMay3_ages)], 
                                          MARGIN = 2, 
                                          FUN = function(a) c(mean(a), sd(a), quantile(a, c(0.025, 0.25, 0.5, 0.75, 0.975)))))
colnames(ABOR1702_01_initMay3_ages_summ)[1:2] <- c("mean", "sd")

ABOR1702_01_initMay3_accurate_summ <- t(apply(X = ABOR1702_01_initMay3_accurate[,1:ncol(ABOR1702_01_initMay3_accurate)], 
                                              MARGIN = 2, 
                                              FUN = function(a) c(mean(a), sd(a), quantile(a, c(0.025, 0.25, 0.5, 0.75, 0.975)))))
...
#ABOR1702_07PU
ABOR1702_07_initMay3_ages_summ <- t(apply(X = ABOR1702_07_initMay3_ages[,1:ncol(ABOR1702_07_initMay3_ages)], 
                                          MARGIN = 2, 
                                          FUN = function(a) c(mean(a), sd(a), quantile(a, c(0.025, 0.25, 0.5, 0.75, 0.975)))))
colnames(ABOR1702_07_initMay3_ages_summ)[1:2] <- c("mean", "sd")

ABOR1702_07_initMay3_accurate_summ <- t(apply(X = ABOR1702_07_initMay3_accurate[,1:ncol(ABOR1702_07_initMay3_accurate)], 
                                              MARGIN = 2, 
                                              FUN = function(a) c(mean(a), sd(a), quantile(a, c(0.025, 0.25, 0.5, 0.75, 0.975)))))
...
ABOR1309_03_run2_initMay14_ages_summ <- t(apply(X = ABOR1309_03_run2_initMay14_ages[,1:ncol(ABOR1309_03_run2_initMay14_ages)], 
                                                MARGIN = 2, 
                                                FUN = function(a) c(mean(a), sd(a), quantile(a, c(0.025, 0.25, 0.5, 0.75, 0.975)))))
colnames(ABOR1309_03_run2_initMay14_ages_summ)[1:2] <- c("mean", "sd")

ABOR1309_03_run2_initMay14_accurate_summ <- t(apply(X = ABOR1309_03_run2_initMay14_accurate[,1:ncol(ABOR1309_03_run2_initMay14_accurate)], 
                                                    MARGIN = 2, 
                                                    FUN = function(a) c(mean(a), sd(a), quantile(a, c(0.025, 0.25, 0.5, 0.75, 0.975)))))
...
#try with new priors and nonconstant supported activity
peck_cores <- read_csv("peck_et_al_2020_depthseries.csv")
#ABOR1309_01PU
ABOR1309_01PU <- peck_cores %>% 
  filter(core_id == "ABOR1309_01PU", depth_max <= 38) %>%
