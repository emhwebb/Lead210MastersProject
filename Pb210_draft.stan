...
transformed parameters {
   ...
   vector<lower = 0>[L] As; //supported activity
...
generated quantities {
  vector[N] accu_rates; //accumulation rates given by 1/m (since m is yr/mm) [or is m given by yr/cm?] <yes
  accu_rates = inv(m); // so accu_rates is in units of cm/yr
}
